class CollaborationsController < ApplicationController
  ...
  def collaboration_params
    if current_user.collaboration and current_user.collaboration.has_payment?
      params.require(:collaboration).permit(:type_amount, :amount, :frequency, :terms_of_service, :minimal_year_old, :ccc_entity, :ccc_office, :ccc_dc, :ccc_account, :iban_account, :iban_bic, :for_autonomy_cc, :for_town_cc, :for_island_cc)
    else
      params.require(:collaboration).permit(:type_amount, :amount, :frequency, :terms_of_service, :minimal_year_old, :payment_type, :ccc_entity, :ccc_office, :ccc_dc, :ccc_account, :iban_account, :iban_bic, :for_autonomy_cc, :for_town_cc, :for_island_cc)
    end
  end
end
